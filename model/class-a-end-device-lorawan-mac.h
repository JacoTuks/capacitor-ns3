...
public:
  ...
  */
  ...
  TracedCallback<> m_closeFirstReceiveWindowCallback;
  TracedCallback<> m_openSecondReceiveWindowCallback;
  TracedCallback<> m_openFirstReceiveWindowCallback;
  TracedCallback<> m_missedRx1becauseOffCallback;
  TracedCallback<> m_missedRx2becauseOffCallback;
  TracedCallback<> m_txFinished;
